...
export const NAV_LABELS: Record<NavTarget, string> = {
  ...
  '/teacher/students/[ref]': 'Student standing',
  '/teacher/together': 'Parent meetings',
  ...
  '/student/timetable': 'Timetable and attendance',
  '/student/topic/[id]': 'Topic detail',
  ...
  '/admin/section/[ref]': 'Section detail',
