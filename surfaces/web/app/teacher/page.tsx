 ...
 * The class summary and the attention list are read GATEWAY-FIRST from the SPINE
 * (intelligence-views: class-insights) through the governed seam, falling back to
 * the TS engine's faithful port only on degrade — so the day reflects real
 * confirmed gaps (never a single bad score). All five designed states ship.
 * Manage by exception: review, act, track outcome.
 */
export default function TeacherDayPage() {
  ...
  return (
    <SurfaceShell
      eyebrow={CLASS_LABEL}
      title="Your day"
      dockIntro="Here is your day with Class 10-B. The attention list is read live from the spine — ask me to explain any student, or build the next quick check."
